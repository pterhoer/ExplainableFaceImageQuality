...
To run the code, use the *XFIQ.py* file. All parameters can be adjusted there. The script takes all images from a folder and saves the raw gradients as well 
...
*setup_img(img)* method in *preprocessing.py*.
